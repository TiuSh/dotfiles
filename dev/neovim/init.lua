...
-- Ignore files
vim.opt.wildignore = {}
concat(vim.opt.wildignore, { '*.o', '*~', '*.pyc' })                                  -- Compile
concat(vim.opt.wildignore, { '.hg', '.git', '.svn' })                                 -- Version control
concat(vim.opt.wildignore, { '*.aux', '*.out', '*.toc' })                             -- LaTeX intermediate files
concat(vim.opt.wildignore, { '*.jpg', '*.bmp', '*.gif', '*.png', '*.jpeg' })          -- binary images
concat(vim.opt.wildignore, { '*.o', '*.obj', '*.exe', '*.dll', '*.manifest' })        -- compiled object files
concat(vim.opt.wildignore, { '*.spl' })                                               -- compiled spelling word lists
concat(vim.opt.wildignore, { '*.sw?' })                                               -- Vim swap files
concat(vim.opt.wildignore, { '.DS_Store' })                                           -- OSX
concat(vim.opt.wildignore, { '*.obj', '*.rbc', '*.class', '*.gem' })                  -- Disable output and VCS files
concat(vim.opt.wildignore, { '*.zip', '*.tar.gz', '*.tar.bz2', '*.rar', '*.tar.xz' }) -- Disable archive files
concat(vim.opt.wildignore, { '*.meteor' })                                            -- Other stuff...
